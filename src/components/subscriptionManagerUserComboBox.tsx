...
export type SubscriptionManagerUserComboBoxProps<
...
export default function SubscriptionManagerUserComboBox<
	TFieldValues extends FieldValues = FieldValues,
	TName extends FieldPath<TFieldValues> = FieldPath<TFieldValues>
>({
	users,
	label,
	control,
}: SubscriptionManagerUserComboBoxProps<TFieldValues, TName>) {
